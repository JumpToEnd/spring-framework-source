...
final class PostProcessorRegistrationDelegate {
     ...
     * 加载顺序：
     * <p>
     * 1. 入参：beanFactoryPostProcessors 中的BeanFactoryPostProcessor <br />
     * 2. BeanDefinitionRegistryPostProcessor <br />
     *    2.1. 实现了PriorityOrdered接口的实现类 <br />
     *    2.2. 实现了Ordered接口的实现类 <br />
     *    2.3. 剩余所有的实现类 <br />
     * 3. BeanFactoryPostProcessor <br />
     *    3.1. 实现了PriorityOrdered接口的实现类 <br />
     *    3.2. 实现了Ordered接口的实现类 <br />
     *    3.3. 剩余所有的实现类 <br />
     *
     * <p>
     *
     * 关于 BeanFactoryPostProcessor 和 BeanDefinitionRegistryPostProcessor 的说明：
     * 1、BeanDefinitionRegistryPostProcessor 继承至 BeanFactoryPostProcessor
     * 2、BeanDefinitionRegistryPostProcessor主要针对的操作对象是BeanDefinition
     * 3、BeanFactoryPostProcessor主要针对的操作对象是BeanFactory
     *
     * @param beanFactory
    ...
    public static void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory, List<BeanFactoryPostProcessor> beanFactoryPostProcessors) {
        ...
        if (beanFactory instanceof BeanDefinitionRegistry) {
            ...
            /*
             *   step 1. 处理入参beanFactoryPostProcessors中的所有BeanFactoryPostProcessor
             */

            // 处理传入的 beanFactoryPostProcessors 集合
            ...
            // 2.1、处理 PriorityOrdered
            // 获取工厂的 beanDefinitionMap 中类型为 BeanDefinitionRegistryPostProcessor 的 beanDefinitionName
        ...
        /*
         *  3. 处理所有的 BeanFactoryPostProcessor
         */
     ...
     *
     * 主要的执行流程:
     * 从BeanFactory获取所有的实现了BeanPostProcessor接口的实现类
     * 1、注册实现了 PriorityOrdered 接口的的BeanPostProcessor
     * 2、注册实现了 Ordered 接口的BeanPostProcessor
     ...
     *
     *
     * 执行实现了BeanDefinitionRegistryPostProcessor接口的实现类的postProcessBeanDefinitionRegistry()方法
     */
     ...
     *
     *
     * 调用实现了BeanFactoryProcessor的实现类的postProcessBeanFactory方法
     */
