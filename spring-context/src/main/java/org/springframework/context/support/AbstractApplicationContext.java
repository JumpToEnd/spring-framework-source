...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
     ...
     * <p>
     * 获取 Environment
     * 如果没有会创建一个新的 Environment  => new StandardEnvironment()
     * <p>
     * <p>
    ...
    public void setParent(@Nullable ApplicationContext parent) {
        ...
        if (parent != null) {
            ...
            // 如果父容器的Environment是ConfigurableEnvironment，就把父容器的Environment和当前的Environment合并
    ...
    public void refresh() throws BeansException, IllegalStateException {
        synchronized (this.startupShutdownMonitor) {
            ...
            try {
                 ...
                 *  调用上下文中注册为bean的各种beanFactory后置处理器
                 */
    ...
    protected void prepareRefresh() {
        ...
        // getEnvironment() 如果没有容器 就创建一个容器 =>  new StandardEnvironment()
        // validateRequiredProperties() 校验必须的配置信息，setRequiredProperties()可以设置必须的配置信息
    ...
    protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
         ...
         *
         * getBeanFactoryPostProcessors() =>  this.beanFactoryPostProcessors  获取已经注册的BeanFactoryPostProcessor
         */
     ...
     *
     * BeanPostProcessor 是操作Bean的
     * <p>
     * Instantiate and register all BeanPostProcessor beans,
     * respecting explicit order if given.
     * <p>Must be called before any instantiation of application beans.
     *
     * PostProcessorRegistrationDelegate  ==>  PostProcessor 注册的代理类
     *
     */
     ...
     *
     * 如果自定义了就使用自定义的
     * 如果没有定义的话使用 SimpleApplicationEventMulticaster
     *
     * 涉及到 Spring 对于事件的一整套管理机制
     *
     * 事件
     * 事件广播器
     * 监听器
     ...
     * <p>
     *
     * 1、对于 通过 getApplicationListeners()获取到的 ApplicationListener ，直接将监听器添加到对应集合里
     * 2、获取容器内所有实现了ApplicationListener的实现类，将name添加到对应集合中，后续会进行初始化
     * 3、对于earlyApplicationEvents，直接遍历进行广播
     *
     *
    ...
    protected void registerListeners() {
        ...
        // 可以使用 addApplicationListener() 方法 添加自定义的监听器
    ...
    protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
        ...
        // 为上下文初始化类型转换器
        // TODO: 2022/4/25 需要研究一下转换服务相关的知识
